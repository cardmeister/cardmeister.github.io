(function(){'use strict';let createElementCardT = CARDTS => {
    ...
    customElements.define('card-t', class extends HTMLElement {
        ...
        attributeChangedCallback(name, oldValue, newValue) {
            ...
            if (name == 'draggable') this.firstChild.setAttribute(name, newValue);
        }
        connectedCallback() {
            drawCard(this);
        }
